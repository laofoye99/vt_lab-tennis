...
class FrameProcessor(SharedData):
    def __init__(self):
        super().__init__()
    ...
    def save_mask(self):
        ...
        cv2.imwrite(self.base_dir + "/data/images/court_mask.png", mask)
        
    def load_mask(self):
        """加载球场掩码"""
        self.court_mask = cv2.imread(self.base_dir + "/data/images/court_mask.png", cv2.IMREAD_GRAYSCALE)
